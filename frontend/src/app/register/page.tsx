      ...
      <div className="bg-white w-full max-w-md rounded-2xl p-8 shadow-xl relative overflow-hidden border border-gray-100">
        ...
        <div className="relative z-10">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-600 to-emerald-500">Superchat</h1>
            <p className="text-sm text-gray-500 mt-2">Create your account to start chatting</p>
          </div>
